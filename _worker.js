// _worker.js — Cloudflare Pages Worker (archivo único, sin imports externos)
...
export default {
    async fetch(request, env, ctx) {
        ...
        if (url.pathname === '/api/diagnostico-cliente') return handleDiagnosticoCliente(request, env);
        if (url.pathname === '/api/aceptar-cotizacion')  return handleAceptarCotizacion(request, env);
